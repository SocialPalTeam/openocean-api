...
class Detail(object):
    ...
    def __init__(self, contract_address=None, collection=None, name=None, image_url=None, schema_name=None, symbol=None, description=None, token_traits=None, token_id=None, payment_assets=None, is_make_offer=None, owner=None, is_flagged=None, orders=None):  # noqa: E501
