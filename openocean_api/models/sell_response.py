...
class SellResponse(object):
    ...
    @property
    def code(self):
        """Gets the code of this SellResponse.  # noqa: E501

        response code, 0-success, -1-fail, 201-invalid params, 500-server error  # noqa: E501

        :return: The code of this SellResponse.  # noqa: E501
        :rtype: float
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this SellResponse.

        response code, 0-success, -1-fail, 201-invalid params, 500-server error  # noqa: E501

        :param code: The code of this SellResponse.  # noqa: E501
        :type: float
        """
        if code is None:
    ...
    @property
    def data(self):
        """Gets the data of this SellResponse.  # noqa: E501


        :return: The data of this SellResponse.  # noqa: E501
        :rtype: SellOrder
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SellResponse.


        :param data: The data of this SellResponse.  # noqa: E501
        :type: SellOrder
        """
