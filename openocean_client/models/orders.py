...
class Orders(object):
    ...
    def __init__(self, id=None, contract_address=None, collection=None, token_id=None, name=None, schema_name=None, market=None, price=None, owner=None, status=None, image_url=None, traits=None, code=None, payment_asset=None, is_flagged=None):  # noqa: E501
