...
class Nfts(object):
    ...
    def __init__(self, contract_address=None, collection_slug=None, collection_name=None, name=None, token_id=None, token_amount=None, on_sale=None, schema_name=None, floor_price=None, image_url=None, code=None, payment_asset=None):  # noqa: E501
