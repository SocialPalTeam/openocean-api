...
class TokenListRequest(object):
    ...
    def __init__(self, chain=None):  # noqa: E501
        """TokenListRequest - a model defined in Swagger"""  # noqa: E501
        self._chain = None
    ...
    @property
    def chain(self):
        """Gets the chain of this TokenListRequest.  # noqa: E501

        chain code  # noqa: E501

        :return: The chain of this TokenListRequest.  # noqa: E501
        :rtype: str
        """
        return self._chain
    ...
    def chain(self, chain):
        """Sets the chain of this TokenListRequest.

        chain code  # noqa: E501

        :param chain: The chain of this TokenListRequest.  # noqa: E501
        :type: str
        """
        if chain is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenListRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenListRequest):
            return False
