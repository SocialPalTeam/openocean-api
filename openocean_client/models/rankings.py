...
class Rankings(object):
    ...
    def __init__(self, id=None, slug=None, name=None, image=None, primary_contract=None, discord_url=None, twitter_username=None, description=None, token_count=None, on_sale_count=None, floor_ask_price=None, floor_price=None, volume=None, volume_change=None, is_verified=None):  # noqa: E501
