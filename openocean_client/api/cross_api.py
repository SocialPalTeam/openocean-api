...
class CrossApi(object):
    ...
    def controller_cross_get_cross_status_with_http_info(self, chain_id, hash, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cross_chain/v1/cross/getCrossStatus', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def controller_cross_get_cross_transaction_with_http_info(self, account, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/cross_chain/v1/cross/getCrossTransaction', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def controller_cross_min_send_with_http_info(self, from_chain_id, to_chain_id, address, **kwargs):  # noqa: E501
        ...
        if ('from_chain_id' not in params or
                params['from_chain_id'] is None):
        ...
        if ('to_chain_id' not in params or
                params['to_chain_id'] is None):
        ...
        return self.api_client.call_api(
            '/cross_chain/v1/cross/getMinSend', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def controller_cross_quote_by_oo_with_http_info(self, from_chain_id, to_chain_id, from_symbol, to_symbol, amount, **kwargs):  # noqa: E501
        ...
        if ('from_symbol' not in params or
                params['from_symbol'] is None):
        ...
        if ('to_symbol' not in params or
                params['to_symbol'] is None):
        ...
        return self.api_client.call_api(
            '/cross_chain/v1/cross/quoteByOO', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
